        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <a href="/academics" className="hover:text-blue-400">
                  Academics
                </a>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <span className="font-medium">Address:</span> 123 School St, City, Country
              </li>
              <li>
                <span className="font-medium">Phone:</span> +1 (123) 456-7890
              </li>
              <li>
                <span className="font-medium">Email:</span> info@schoolmanagement.com
              </li>
            </ul>
          </div>
