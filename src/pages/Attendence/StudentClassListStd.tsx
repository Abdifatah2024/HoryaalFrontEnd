...
// import {
//   Box, Container, FormControl, InputLabel, MenuItem, Paper, Select,
//   SelectChangeEvent, Table, TableBody, TableCell, TableContainer, TableHead,
//   TableRow, Typography, useTheme, Button, TextField, Chip, Avatar, Grid
// } from "@mui/material";
...
//         const resultAction = await dispatch(markAttendance({
//           studentId: +id,
...
//             <Typography variant="h4" fontWeight={700} gutterBottom>Student Attendance</Typography>
//             <Typography variant="subtitle1" color="text.secondary">Track and manage class attendance</Typography>
//           </Grid>
//           <Grid item xs={12} md={3}>
//             <FormControl fullWidth size="medium">
//               <InputLabel>Select Class</InputLabel>
//               <Select value={selectedClassId} label="Select Class" onChange={handleChange} sx={{ borderRadius: 3 }}>
//                 {classList.map((cls) => <MenuItem key={cls.id} value={cls.id}>{cls.name}</MenuItem>)}
//               </Select>
//             </FormControl>
//           </Grid>
//           <Grid item xs={12} md={3}>
//             <Button fullWidth variant="outlined" onClick={handleDownloadPDF} sx={{ borderRadius: 3, fontWeight: 600 }}>
