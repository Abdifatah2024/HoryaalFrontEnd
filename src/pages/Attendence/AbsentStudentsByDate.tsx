...
//   return (
//     <Box p={3}>
//       <Typography variant="h4" mb={3}>Absent Students by Date</Typography>
...
//         <Button
//           variant="contained"
//           onClick={() => selectedDate && dispatch(fetchAbsentStudentsByDate(selectedDate.format('YYYY-MM-DD')))}
//         >
//           Refresh
//         </Button>
//       </Box>
...
//         <Typography>No absent students found for this date.</Typography>
//       )}
