...
// const mockSubjects = [
//   { id: 1, name: "Chemistry" }, { id: 2, name: "Biology" },
//   { id: 3, name: "Physics" }, { id: 4, name: "Math" },
//   { id: 5, name: "English" },
// ];
...
//     error,
//     success,
//   } = useSelector((state: RootState) => state.teacherAssignment);
...
//   const handleAssign = () => {
//     if (!teacherId) return;
//     dispatch(assignTeacherToClassSubject({ teacherId: Number(teacherId), classId, subjectId }));
//   };
...
//   dispatch(deleteTeacherAssignment(id)).then((res) => {
//     if (res.meta.requestStatus === "fulfilled") {
//       toast.success("Assignment deleted successfully");
//       setEditAssignmentId(null);
//       dispatch(fetchTeacherAssignments(Number(teacherId))); // Refresh list
//     } else {
...
//       console.error("Assignment object is missing a valid ID:", a);
...
//                       primary={
//                         <>
//                           <Chip label={a.className} sx={{ mr: 1 }} />
//                           <Chip label={a.subjectName} color="secondary" />
//                         </>
//                       }
//                     />
//                   )}
