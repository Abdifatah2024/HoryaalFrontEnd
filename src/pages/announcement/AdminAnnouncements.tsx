...
// import utc from 'dayjs/plugin/utc'; // Import UTC plugin for consistent date handling
...
// } from './announcementSlice'; // Assuming this path is correct
// import { RootState, AppDispatch } from '../../Redux/store'; // Assuming this path is correct

// // Import React Icons for a modern look
// import {
//   FiBell,
//   FiCalendar,
//   FiClock,
...
//   FiAlertCircle,
//   FiTarget,
//   FiZap, // For urgent announcements
//   FiCheckCircle, // For active announcements
// } from 'react-icons/fi';

// // Define the Announcement interface based on your Redux state structure
// // This is crucial for TypeScript, if not using TypeScript, you can omit this.
// interface Announcement {
//   id: string; // Assuming ID is string or number
//   title: string;
//   message: string;
//   createdAt: string;
//   startDate: string;
...
//   isUrgent?: boolean; // Added for extra visual cue
//   createdBy: {
//     fullName: string;
//     role: string;
//   };
...
//     return anns.map((ann) => {
//       const now = dayjs();
//       const startDate = dayjs.utc(ann.startDate); // Use UTC for consistent parsing
...
//         } else {
//           // Display relative time for remaining
//           timeRemaining = endDate.fromNow(true) + ' left'; // '5 days left', '2 hours left'
//           if (endDate.diff(now, 'day') < 2) { // For less than 2 days, show in hours/minutes
//             timeRemaining = endDate.diff(now, 'hour') > 0 ? `${endDate.diff(now, 'hour')} hours left` : `${endDate.diff(now, 'minute')} minutes left`;
//           }
//         }
//       }

//       // Determine if urgent (e.g., expires within 24 hours, or explicitly marked)
...
//         timeRemaining,
//         isUrgent,
//         // Ensure createdBy is correctly structured
//         createdBy: {
...
//       };
//     }).sort((a, b) => {
//         // Sort by expiration status (expired last), then by urgency (urgent first), then by date
...
//       >
//         <h2 className="text-4xl font-extrabold mb-8 text-gray-900 flex items-center gap-3">
