...
// //   year: number;
// //   createdById: number;
// //   employee: { fullName: string; phone: string };
...
// //         state.advances.unshift(action.payload.advance);
// //         state.summary = action.payload.summary;
// //         state.totalCount += 1;
// //       })
// //       .addCase(updateAdvance.fulfilled, (state, action) => {
// //         const index = state.advances.findIndex(
// //           (a) => a.id === action.payload.advance.id
// //         );
// //         if (index !== -1) state.advances[index] = action.payload.advance;
// //         state.summary = action.payload.summary;
// //       })
...
// //         state.totalCount -= 1;
// //         if (state.summary) {
// //           state.summary.totalAdvance = state.advances.reduce(
// //             (sum, adv) => sum + adv.amount,
// //             0
// //           );
// //           state.summary.numberOfAdvances = state.advances.length;
// //         }
// //       });
// //   },
// // });
...
//       // ✅ FIX: payload is the Advance object directly, not { advance }
//       .addCase(createAdvance.fulfilled, (state, action) => {
